...
function displayPics(){
  ...
  // console.log(rando);
  // In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `let to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT
  // The above console log breaks because rando is now a block-scoped variable inside the while loop it exists in, therefore it cannot be referenced or used outside that code block.
  console.log(viewed);
